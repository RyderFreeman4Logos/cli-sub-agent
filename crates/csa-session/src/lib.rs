...
pub use manager::{
    ...
    audit_repo_tracked_writes, complete_session, contract_result_path, create_session,
    create_session_fresh, delete_session, delete_session_from_root, detect_git_head, find_sessions,
    get_session_dir, get_session_dir_global, get_session_root, legacy_user_result_path,
