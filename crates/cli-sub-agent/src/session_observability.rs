...
use crate::review_cmd::output::consistency::repair_clean_empty_fail_review_verdict;
...
mod review_verdict;
#[path = "session_observability_summary_gate.rs"]
mod summary_gate;
pub(crate) use registry::{
    build_session_registry_lookup_miss_diagnostic, emit_session_registry_state_loss_diagnostic,
};
pub(crate) use summary_gate::human_review_summary_requires_failed_gate;
...
pub(crate) fn refresh_and_repair_result_from_dir(
    ...
    changed |= repair_clean_empty_fail_review_verdict(session_dir)?;
