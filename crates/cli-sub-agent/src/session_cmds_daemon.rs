...
pub(crate) use completion::{
    daemon_completion_exists, finalize_daemon_completion_if_present, load_daemon_completion_packet,
    persist_daemon_completion_from_env, seed_daemon_session_env,
};
#[cfg(test)]
