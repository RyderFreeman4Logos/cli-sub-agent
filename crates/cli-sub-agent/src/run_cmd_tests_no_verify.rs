...
#[test]
fn apply_no_verify_commit_policy_does_not_treat_second_message_value_as_no_verify_flag() {
    let mut result = ExecutionResult {
        output: String::new(),
        summary: "ok".to_string(),
        ..Default::default()
    ...
    let executed_shell_commands =
        vec!["git commit -m 'msg' -m '- Verification: pre-commit'".to_string()];
...
#[test]
fn apply_no_verify_commit_policy_blocks_real_short_no_verify_flag_after_message() {
    let mut result = ExecutionResult {
        output: String::new(),
        summary: "ok".to_string(),
        ..Default::default()
    };
    let executed_shell_commands = vec!["git commit -m 'msg' -n".to_string()];
...
#[test]
fn apply_no_verify_commit_policy_does_not_treat_dash_a_as_dash_n_in_combined_flags() {
    let mut result = ExecutionResult {
        output: String::new(),
        summary: "ok".to_string(),
        ..Default::default()
    };
    let executed_shell_commands = vec!["git commit -am 'msg'".to_string()];
...
#[test]
fn apply_no_verify_commit_policy_blocks_dash_n_inside_combined_short_flags() {
    let mut result = ExecutionResult {
        output: String::new(),
        summary: "ok".to_string(),
        ..Default::default()
    };
    let executed_shell_commands = vec!["git commit -nm 'msg'".to_string()];
