...
# Exact ratchet: 45 core + 7 hostile + 6 isolation + 1 pre-push + 2
# dev2merge runtime contracts = 61 independently named PASS cases.
...
run_contract_suite scripts/tests/quality-gate-isolation-tests.sh 6
