...
4. Write `result.toml` to `$CSA_RESULT_TOML_PATH_CONTRACT` (fallback: `$CSA_SESSION_DIR/result.toml`; set `[result].attempt_nonce` to `$CSA_RESULT_TOML_ATTEMPT_NONCE`; `todo_path = "$CSA_SESSION_DIR/artifacts/TODO.md"`)
