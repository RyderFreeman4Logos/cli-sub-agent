...
5. **Phase 3 -- DEBATE**: Run explicit `csa debate --tool gemini-cli` (tier-2) via bash step, then normalize stdout into an evidence packet with headers: `DEBATE_EVIDENCE`, `VALID_CONCERNS`, `SUGGESTED_CHANGES`, `OVERALL_ASSESSMENT`.
